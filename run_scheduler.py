...
def main(num_requests, min_tokens, max_tokens, inference_delays, policy):  
...
if __name__ == "__main__":  
    ...
    for num_requests in num_requests_values:  
        goodput_random = main(num_requests, min_tokens, max_tokens, inference_delays, policy='random')  
    ...
    for num_requests in num_requests_values:  
        goodput_bidding = main(num_requests, min_tokens, max_tokens, inference_delays, policy='bidding')  
